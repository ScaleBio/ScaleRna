...
plotViolin(dat = clusterDat, groupVar = clusterColumn, datVar = "umis") + legend_theme + guide_opts_vln + labs(fill = "Cluster") + xlab("Cluster") + ylab("# of UMIs") + labs(title = "Number of UMIs per Cluster")
```
